...
class Py2048:
    def __init__(self):
        ...
        pygame.font.init()
        self.myfont = pygame.font.Font("assets/Roadgeek 2005 series 5wr.ttf", 40)
    ...
    @staticmethod
    def _get_nums(this):
        sound1 = pygame.mixer.Sound('assets/sound2048.wav')
        this_n = this[this != 0]
        this_n_sum = []
        skip = False
    ...
    def draw_game(self):
        ...
        for i in range(N):
            for j in range(N):
                ...
                rect_x = j * self.W // N + 150 + self.SPACING
                rect_y = i * self.H // N + 50 + self.SPACING
                ...
                if n == 0:
                    continue
                if n == 2 or n == 256 or n == 1024:
                    text_surface = self.myfont.render(f'{n}', True, (64, 64, 64))
                else:
                    text_surface = self.myfont.render(f'{n}', True, (204, 255, 229))
